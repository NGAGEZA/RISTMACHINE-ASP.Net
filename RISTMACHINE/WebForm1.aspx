<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/RMaster.Master" CodeBehind="WebForm1.aspx.vb" Inherits="RISTMACHINE.WebForm1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        ...
        function LoadChart() {
            ...
            $.ajax({
                type: "POST",
                url: "WebService_Test.asmx/GetChart",
